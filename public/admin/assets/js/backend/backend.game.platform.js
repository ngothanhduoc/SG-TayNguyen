...
var arrCat = [];
var BACKEND = {
    API_URL_LIST: '/backend/list/platform',
    AJAX_URL_DELETE: '/backend/ajax/delete/admin_game/platform/platform/id_platform',
    OBJ_GRID: null,
    ...
    init: function() {
        ...
        BACKEND.OBJ_GRID.jqxGrid({
            ...
            columns: [
                ...
                {text: 'CÔNG CỤ', datafield: 'id_platform', cellsalign: 'center', align: 'center', cellsrenderer: BACKEND.toolscolumnrender, width: 80, sortable: false, filterable: false},
            ],
            virtualmode: true,
    ...
    gridEdit: function(id) {
        //loadPopup(id, false);
        window.location.href = '/backend/game/add_platform?id=' + id;
    },
}