...
var BACKEND = {
    API_URL_LIST: '/backend/list/slide',
    AJAX_URL_DELETE: '/backend/ajax/delete/admin_home/index/slide/id_slide',
    AJAX_URL_UPDATE: '/backend/ajax/updatestatus/admin_home/index/slide/id_slide',
...
//		{text: 'CONTENT', datafield: 'description'},
    ...
    gridEdit: function(id) {
        //loadPopup(id, false);
        window.location.href = '/backend/home/add?id=' + id;
    },
    setBc: function(id){
        $.ajax({
