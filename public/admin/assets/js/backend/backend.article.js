...
var BACKEND = {
    API_URL_LIST: '/backend/list/article',
    AJAX_URL_DELETE: '/backend/ajax/delete/admin_article/index/article/id',
    AJAX_URL_UPDATE: '/backend/ajax/updatestatus/admin_article/index/article/id',
        ...
        var dataAdapter = new $.jqx.dataAdapter(source, {
            beforeLoadComplete: function (records) {
                ...
                for (var i = j; i < records.length; i++) {
                    ...
                    records[i].userName = users[records[i].created_by];
    ...
    init: function() {
	    ...
	    columns: [
                ...
                {text: 'ID', datafield: 'idCoppy', width: 150},
		{text: 'TITLE', datafield: 'title'},
                {text: 'CREATE BY', datafield: 'userName', filterable: false, sortable: false, width: 150},
    ...
    gridEdit: function(id) {
        //loadPopup(id, false);
        window.location.href = '/backend/article/add?id=' + id;
    },
    setBc: function(id){
        $.ajax({
