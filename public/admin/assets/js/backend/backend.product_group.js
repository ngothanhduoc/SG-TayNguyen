...
var BACKEND = {
    API_URL_LIST: '/backend/list/group_product',
    AJAX_URL_DELETE: '/backend/ajax/delete/admin_group_product/index/group_product/id_group_product',
    AJAX_URL_UPDATE: '/backend/ajax/updatestatus/admin_group_product/index/group_product/id_group_product',
    ...
    dataAdapter: function() {
        ...
        var source = {
            datatype: "jsonp",
            datafields: [
                {name: 'id_group_product', type: 'int'},
        ...
        var dataAdapter = new $.jqx.dataAdapter(source, {
            beforeLoadComplete: function (records) {
                ...
                for (var i = j; i < records.length; i++) {
                    records[i].idCoppy = records[i].id_group_product;
    ...
    gridEdit: function(id) {
        //loadPopup(id, false);
        window.location.href = '/backend/group_product/add?id=' + id;
    },
    setBc: function(id){
        $.ajax({
